...
/* harmony export */ });
/* harmony import */ var _OneProject_class__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./OneProject_class */ "./src/OneProject_class.js");
...
class AllProjects {
  ...
  addProject(name) {
    ...
    this.projects.push(new _OneProject_class__WEBPACK_IMPORTED_MODULE_0__["default"](projectName));
  }
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ OneProject)
/* harmony export */ });
/* harmony import */ var _Note_class__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Note_class */ "./src/Note_class.js");
...
class OneProject {
  ...
  addNote(name, description) {
    ...
    this.notes.push(new _Note_class__WEBPACK_IMPORTED_MODULE_0__["default"](noteName, description));
  }
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ loadLocalStorage)
/* harmony export */ });
/* harmony import */ var _OneProject_class__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./OneProject_class */ "./src/OneProject_class.js");
/* harmony import */ var _Note_class__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Note_class */ "./src/Note_class.js");
...
function loadLocalStorage() {
  if (localStorage.length === 0) {
    _userInterface__WEBPACK_IMPORTED_MODULE_2__.ALLPROJECTS.projects.push(new _OneProject_class__WEBPACK_IMPORTED_MODULE_0__["default"]('index'));
    ...
    (storageAllProjects.projects).forEach((project) => {
      _userInterface__WEBPACK_IMPORTED_MODULE_2__.ALLPROJECTS.projects.push(new _OneProject_class__WEBPACK_IMPORTED_MODULE_0__["default"](project.name));

      (project.notes).forEach((note) => {
        const tempNote = new _Note_class__WEBPACK_IMPORTED_MODULE_1__["default"](note.name, '');
        tempNote.checked = note.checked;
        tempNote.dueDate = note.dueDate;
        _userInterface__WEBPACK_IMPORTED_MODULE_2__.ALLPROJECTS.projects[_userInterface__WEBPACK_IMPORTED_MODULE_2__.ALLPROJECTS.projects.length - 1].notes.push(tempNote);
      });
    });
  }

  (0,_userInterface__WEBPACK_IMPORTED_MODULE_2__.loadNotes)(); // load index notes as default display
  (0,_userInterface__WEBPACK_IMPORTED_MODULE_2__.loadProjects)();
  (0,_userInterface__WEBPACK_IMPORTED_MODULE_2__.addProject)();
  (0,_userInterface__WEBPACK_IMPORTED_MODULE_2__.addNote)();
  (0,_userInterface__WEBPACK_IMPORTED_MODULE_2__.toggleMobileNavMenu)();
}
...
/* harmony import */ var _AllProjects_class__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./AllProjects_class */ "./src/AllProjects_class.js");



const ALLPROJECTS = new _AllProjects_class__WEBPACK_IMPORTED_MODULE_0__["default"]();
...
function displayNote(noteName) {
  ...
  dueDateInput.addEventListener('input', () => {
    ...
    dueDateSpan.innerText = (0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(dueDateInput.valueAsDate, 'MM/dd/yyyy');
    dueDateInput.style.display = 'none';
